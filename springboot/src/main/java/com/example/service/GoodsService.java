...
//协同过滤推荐 将相似用户的喜好推荐
    public List<Goods> recommend() {
        ...
        System.out.println("测试测试！！！" +goodsIds);
        // 把商品id转换成商品
...
//基于用户喜好推荐 购物车 订单 收藏 评论
    public List<Goods> conduct() {
        Account currentUser = TokenUtils.getCurrentUser();

        // 用户的哪些行为可以认为他跟商品产生了关系？收藏、加入购物车、下单、评论
        //获取该用户的购物车商品id 获取商品id对应的类型id
...
//        List<Cart> userGoods = cartMapper.selectByUserId(userId);
//        System.out.println("test测试！"+userGoods);
