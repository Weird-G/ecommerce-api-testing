    ...
    <div style="width: 60%; background-color: white; min-height: 1000px; margin: 20px auto; border-radius: 20px">
      <div style="padding: 15px 20px">
        <el-row :gutter="20">
          ...
          <el-col :span="12" >
            <div style="font-size: 30px; margin-top: 30px; font-weight: 900; overflow: hidden; text-overflow: ellipsis; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical;">{{goodsData.name}}</div>
...
<!--              <img src="@/assets/imgs/广告.png" alt="" style="width: 70%; height: 100px; border-radius: 15px">-->
<!--            </div>-->
            <div style="color: #666666FF; margin-top: 20px">商家：<a style="color: #666666FF" href="#" @click="navTo('/front/business?id=' + goodsData.businessId)">{{goodsData.businessName}}</a></div>
            <div style="color: #666666FF; margin-top: 20px">分类：<a style="color: #666666FF" href="#" @click="navTo('/front/type?id=' + goodsData.typeId)">{{goodsData.typeName}}</a></div>
            <div style="color: #666666FF; margin-top: 20px">库存 ：<a style="color: #666666FF" >999+</a></div>
            <div style="color: #666666FF; margin-top: 30px">
              <el-button type="success" @click="addCart">加入购物车</el-button>
              <el-button type="success" @click="collect">收藏</el-button>
            </div>
          </el-col>
        </el-row>
      </div>
