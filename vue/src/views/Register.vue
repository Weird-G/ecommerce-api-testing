<template>
  <div class="container">
    <div style="width: 400px; padding: 30px; background-color:rgb(251,252,252,0.8); border-radius: 5px;">
      ...
      <el-form :model="form" :rules="rules" ref="formRef">
        ...
        <el-form-item>
          <el-button style="width: 100%; background-color: rgba(28,71,90); border-color: rgb(49,127,161); color: rgb(195,219,231)" @click="register">注 册</el-button>
        </el-form-item>
